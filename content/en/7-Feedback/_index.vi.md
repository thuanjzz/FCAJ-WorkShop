...
Mentor Nguyễn Gia Hưng hướng dẫn ở mức độ phù hợp — không cho câu trả lời trực tiếp mà chỉ đường đến tài liệu AWS đúng và đặt câu hỏi phù hợp để thúc đẩy tư duy phản biện. Các buổi review kiến trúc ở Tuần 10 đặc biệt có giá trị. Tôi đặc biệt trân trọng việc mentor tin tưởng giao cho tôi toàn quyền sở hữu module AI pipeline.
...
Chương trình 11 tuần có cấu trúc tốt (học nền tảng AWS trước, rồi làm dự án). Sự cân bằng giữa học có hướng dẫn (Tuần 1–4) và tự chủ sở hữu dự án (Tuần 5–11) phù hợp với trình độ người tham gia. Có GitHub repo thực, AWS account thực, chi phí AI API thực khiến mọi quyết định đều có ý nghĩa.

---

### Bài học chính

- **Khoảnh khắc thỏa mãn nhất:** Lần đầu tiên toàn bộ AI pipeline — scene detection → Bedrock captioning → pgvector search — chạy end-to-end ở Tuần 7. Nhìn thấy query ngôn ngữ tự nhiên trả về đúng scene video trong chưa đầy 2 giây là khoảnh khắc đột phá.
...
- **Có giới thiệu FCAJ không?** Chắc chắn. Với sinh viên muốn vượt qua mức học cloud theo tutorial sang sở hữu hệ thống production thực sự, FCAJ là một trong những cơ hội tốt nhất hiện có tại Việt Nam.
