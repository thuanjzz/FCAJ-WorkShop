...
### Mục tiêu tuần 2 (26/04 – 03/05/2026):
...
| --- | --------- | ------------ | --------------- | -------------- |
| CN  | Tìm hiểu Amazon S3: tạo bucket, lưu trữ object, versioning, lifecycle policies, presigned URLs, static website | 26/04/2026 | 27/04/2026 | https://cloudjourney.awsstudygroup.com/ |
...
* Nắm vững Amazon S3: bucket policies, versioning, lifecycle rules, static website hosting và presigned URLs.
...
* Hiểu cách các dịch vụ này kết nối với nhau, tạo nền tảng cho kiến trúc cloud-native.
