...
### Mục tiêu tuần 4 (10/05 – 17/05/2026):
...
| --- | --------- | ------------ | --------------- | -------------- |
| CN  | Tìm hiểu kiến trúc serverless: lợi ích, hạn chế, use cases; API Gateway (REST vs HTTP API) | 10/05/2026 | 11/05/2026 | https://cloudjourney.awsstudygroup.com/ |
