...
Để đảm bảo tính độc nhất toàn cầu (Globally Unique) và bảo mật dữ liệu, chúng ta sẽ khởi tạo một Bucket mới.
...
Theo mặc định hệ thống, Amazon S3 sẽ không chủ động phát tán dữ liệu sự kiện ra ngoài. Để chuỗi đường ống điều phối bất đồng bộ tại Chương 5.6 có thể hoạt động, chúng ta cần kích hoạt tính năng thông báo:
...
**Bước tiếp theo:** Hệ thống lưu trữ tệp (File Storage) đã sẵn sàng. Chúng ta sẽ tiếp tục thiết lập bộ nhớ dữ liệu có cấu trúc tại bài **5.4.2: Tạo RDS PostgreSQL** để phục vụ việc lưu trữ metadata và vector tìm kiếm cho AI.
