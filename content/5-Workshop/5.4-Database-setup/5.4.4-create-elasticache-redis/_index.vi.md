...
3. **Step 2: Advanced settings (Cài đặt nâng cao - Rất quan trọng):**
   ...
   * **Encryption in transit:** Mặc định AWS có thể sẽ Bật (Enable) tính năng này. Nếu bật, bạn bắt buộc phải cấu hình URL kết nối là `rediss://` thay vì `redis://` trong ứng dụng của bạn. Nếu không, ứng dụng sẽ bị treo (Timeout) khi kết nối vì server đang đợi TLS handshake.
