...
Trong phần này, chúng ta sẽ tiến hành kiểm tra trạng thái hoạt động của NAT Gateway và phân tích sâu các Bảng định tuyến (Route Tables) để hiểu rõ luồng giao thông mạng được kiểm soát như thế nào.
...
3. Quan sát mục **Elastic IP address**: Đây là địa chỉ IP tĩnh công cộng duy nhất mà AWS cấp phát riêng cho bạn. Kể từ bây giờ, mọi luồng dữ liệu từ tất cả các máy chủ Private Subnet khi đi ra thế giới bên ngoài sẽ đều "ngụy trang" dưới địa chỉ IP công cộng này.
