...
*(Hướng dẫn chụp: Chụp tại màn hình điền Provider URL và Audience trước khi bấm nút Add provider).*
...
*(Hướng dẫn chụp: Chụp màn hình tab "Trust relationships" của Role vừa tạo, hiển thị rõ đoạn JSON có tên repo smart_media_analytics_cloudforge).*
