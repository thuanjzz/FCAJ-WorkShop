...
*(Hướng dẫn chụp: Chụp lại màn hình Create repository đã điền tên cloudforge-backend, sau đó mới bấm Create).*
...
*(Hướng dẫn chụp: Chụp lại màn hình tab Actions trên GitHub báo tích xanh Success cho luồng Deploy).*
